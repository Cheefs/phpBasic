    ...
    <div class="right-side">
        ...
        <div class="product-block">
            <?php foreach ($products?? [] as $product) :?>
                <div class="product" data-id="${this.id}">
                    <a href="/view.php?id=<?= $product['id'] ?>" class="photo-link">
                        <div class="photo" data-id="<?= $product['id'] ?>">
                            <img class="photo_img" src="<?= ROOT_DIR.$product['photo'] ?>" >
                        </div>
                    </a>
                    <div class="buttons">
                        <a href="/engine/cart/add.php?product_id=<?= $product['id'] ?>" methods="post" class="product-btn add-to-cart">
        ...
        <div class="bottom">
            <div class="pages-block">
                ...
                <a class="pages-block-a active" href="#">1</a>
