...
<div class="product-top-panel">
    <div class="container">
        <h3 class="top-panel-h3"><a class="breadcrumbs-a" href="#">Single Page</a></h3>
        <nav class="breadcrumbs">
            <a class="breadcrumbs-a" href="/index.php">Home</a><span>/</span>
            <a class="breadcrumbs-a" href="/index.php">Product</a><span>/</span>
            <a class="breadcrumbs-a" href="/index.php">Woman</a><span>/</span>
...
<div class="container product-info">
    ...
    <section class="comments" id="comments">
            ...
            <?php foreach ($feedbackList as $feedback):?>
                <div class="comment">
                    <div class="comment__header">
                        ...
                        <div>
                            <a class="button" href="/view.php?id=<?= $product['id'] ?>&feedback_id=<?= $feedback['id'] ?>&#comments">
                                <i class="fas fa-pencil-alt"></i>
                            </a>
                            <a class="button" href="/engine/feedback/delete.php?id=<?= $feedback['id'] ?>&product_id=<?= $product['id'] ?>">
        ...
        <form action="/engine/feedback/create.php" class="comment__form" method="post">
